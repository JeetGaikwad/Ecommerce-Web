...
function CheckOut() {
    ...
    return (
        <>
            <div className="mx-auto max-w-5xl pt-5 px-4 sm:px-6 lg:px-8">
                <div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
                    <div className='lg:col-span-3'>
                        <form className='bg-white p-6 mt-6'>
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <ul role="list" className="divide-y divide-gray-100">
                                    {addresses.map((address) => (
                                        <li key={address.street} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                                            <div className="flex min-w-0 gap-x-4">
                                                <input
                                                    name="address"
                                                    type="radio"
                                                    className="size-4 mt-2 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                                                />
                                            ...
                                            <div className="flex min-w-0 gap-x-4">
                                                <div className="min-w-0 flex-auto">
                                                    <p className="text-sm/6 font-semibold text-gray-900">{address.phone}</p>
                                                    <p className="mt-1 truncate text-xs/5 text-gray-500">{address.city}</p>
                                                </div>
                                            </div>
                                        </li>
                                    ))}
                    ...
                    <div className='lg:col-span-2'>
                        <div className="mx-auto mt-6 max-w-5xl px-0 sm:px-0 lg:px-0">
                            <div className="border-t bg-white border-gray-200 px-4 py-6 sm:px-6">
                                <h1 className='text-4xl my-5 font-bold tracking-light text-gray-900'>Cart</h1>
                                                ...
                                                <div className="ml-4 flex flex-1 flex-col">
                                                    ...
                                                    <div className="flex flex-1 items-end justify-between text-sm">
                                                        <div className="text-gray-500">
                                                            <label htmlFor="quantity" className='inline mr-4 text-small font-medium leading-6 text-gray-900'>Qnt:</label>
                                                            <select>
